...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* 1. Extremely subtle paper grain/noise texture overlay */}
      <div 
        className="absolute inset-0 pointer-events-none opacity-[0.025] mix-blend-overlay z-20" 
        style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 256 256' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noise'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.98' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noise)'/%3E%3C/svg%3E")`,
      ...
      {/* 3. Hand-drawn botanical line illustrations in corners */}
      {/* Top-Left Botanical Branch */}
      <svg className="absolute top-0 left-0 w-[380px] h-[380px] text-text-primary/[0.035] pointer-events-none hidden md:block" viewBox="0 0 200 200" fill="none" stroke="currentColor" strokeWidth="0.45" strokeLinecap="round">
        <path d="M 0,0 C 45,45 85,65 125,70" />
        <path d="M 32,24 C 40,12 50,17 44,30 C 38,42 28,37 32,24 Z" />
        <path d="M 62,42 C 74,30 82,34 78,48 C 74,62 64,56 62,42 Z" />
        <path d="M 92,55 C 107,44 114,50 108,62 C 102,74 94,68 92,55 Z" />
        <path d="M 17,27 C 12,40 5,44 10,50 C 15,56 22,48 17,27 Z" />
        <path d="M 47,50 C 40,64 32,70 38,76 C 44,82 52,72 47,50 Z" />
      </svg>
      {/* Bottom-Right Botanical Branch */}
      <svg className="absolute bottom-0 right-0 w-[380px] h-[380px] text-text-primary/[0.035] pointer-events-none hidden md:block rotate-180" viewBox="0 0 200 200" fill="none" stroke="currentColor" strokeWidth="0.45" strokeLinecap="round">
        <path d="M 0,0 C 50,40 95,55 140,57" />
        <path d="M 37,22 C 47,10 54,14 50,27 C 46,40 38,34 37,22 Z" />
        <path d="M 72,40 Q 84,28 80,45 C 76,58 68,52 72,40 Z" />
        <path d="M 107,50 C 122,40 128,44 124,56 Q 116,68 107,50 Z" />
        <path d="M 22,27 C 14,40 7,44 12,50 C 17,56 24,48 22,27 Z" />
      </svg>

      {/* 4. Topographic contour lines behind the content */}
      <svg className="absolute inset-0 w-full h-full text-text-primary/[0.016] dark:text-text-primary/[0.025] pointer-events-none" viewBox="0 0 1440 900" preserveAspectRatio="none" fill="none" stroke="currentColor" strokeWidth="0.75" strokeLinecap="round">
        <path d="M -100,180 C 250,90 450,300 780,190 C 1120,80 1220,530 1600,400" />
        <path d="M -100,250 C 260,150 460,360 790,250 C 1130,140 1230,590 1600,460" />
        <path d="M -100,320 C 270,210 470,420 800,310 C 1140,200 1240,650 1600,520" />
        <path d="M -100,390 C 280,270 480,480 810,370 C 1150,260 1250,710 1600,580" />
        <path d="M -100,460 C 290,330 490,540 820,430 C 1160,320 1260,770 1600,640" />
        <path d="M -100,530 C 300,390 500,600 830,490 C 1170,380 1270,830 1600,700" />
      </svg>

      {/* 7. Cinematic vignette effect pulling eye to the center */}
      <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_center,transparent_60%,rgba(244,246,245,0.35)_100%)] dark:bg-[radial-gradient(circle_at_center,transparent_45%,rgba(12,20,17,0.75)_100%)] mix-blend-multiply z-10" />

      {/* 8. Very slow floating dust particles */}
      {Array.from({ length: 9 }).map((_, i) => {
        ...
        return (
          <motion.div
            key={i}
            className="absolute bg-text-primary/10 rounded-full blur-[0.5px] pointer-events-none"
            style={{
              left: `${xStart}%`,
              top: `${yStart}%`,
              width: size,
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-12 items-center relative z-10">
        ...
        >
          {/* 6. Tiny handwritten accent: Growth with intent */}
          <div className="absolute -top-10 left-[8%] rotate-[-4deg] font-handwriting text-accent-orange text-lg font-bold tracking-wide pointer-events-none hidden md:block opacity-90">
            Growth with intent &rarr;
          </div>
          ...
          <div className="mt-10 flex flex-wrap items-center gap-4 md:gap-6 relative">
            ...
            {/* 6. Tiny handwritten accent: Built for trust */}
            <div className="absolute -bottom-10 left-[4%] rotate-[-2deg] font-handwriting text-accent-orange text-base font-bold tracking-wide pointer-events-none hidden md:block opacity-95">
              &larr; Built for trust
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            {/* 6. Tiny handwritten accent: Founder-led agency */}
            <div
              style={{ transform: 'translateZ(25px)' }}
              className="absolute -left-12 -bottom-10 z-30 font-handwriting text-accent-orange text-lg lg:text-xl -rotate-3 select-none font-bold hidden md:flex items-center gap-1.5 pointer-events-none opacity-95"
            >
              Founder-led agency &rarr;
            </div>

          </motion.div>

          {/* 6. Handwritten note for Mobile */}
